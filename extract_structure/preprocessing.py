    ...
    def train(self, train_loader, val_loader, num_epochs=20, save_path="./models"):
        ...
        for epoch in range(num_epochs):
            ...
            for batch in tqdm(train_loader, desc="Training"):
                ...
                total_loss = label_loss + order_loss + 3 * linking_loss
...
def run_pdf_to_blocks(pdf_path):
    """
    Wrapper used by model.py to get structured blocks from PDF
    """
    return extract_paragraphs_with_ocr(pdf_path)["contents"]
